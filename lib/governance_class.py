...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to goacoind "gobject list" output
    ...
    def goacoind_serialise(self):
        import goacoinlib
        return goacoinlib.SHIM_serialise_for_goacoind(self.serialise())
