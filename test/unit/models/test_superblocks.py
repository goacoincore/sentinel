...
def go_list_proposals():
    items = [
        ...
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "fernandez-7625", "payment_address": "yTC62huR4YQEPn9AJHjnQxxreHSbgAoatV", "payment_amount": 32.01, "start_epoch": 1474261086, "type": 1, "url": "http://goacoincentral.org/fernandez-7625"}]]',
...
def test_deterministic_superblock_creation(go_list_proposals):
    ...
    sb = goacoinlib.create_superblock(prop_list, 72000, budget_max=max_budget, sb_epoch_time=misc.now())
